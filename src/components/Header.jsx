...
const Header = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const ToolListSection = ({ title, toolIds, allTools, setToolsDropdownOpen }) => {
    return (
      <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-3">
          <div className="flex items-center space-x-4">
            ...
            <Link  onClick={() => setActiveTool(null)} to='/'  className="flex items-center space-x-2">
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                  ...
                  {/* Section 4: Utility Tools */}
                    <ToolListSection
                      title="Utility Tools"
                      toolIds={['image-compressor', 'password-generator', 'word-counter', 'color-picker', 'bmi-calculator', 'json-formatter', 'unit-converter', 'age-calculator']} // Example IDs
                      allTools={allTools} // Pass your full tool list
                      setToolsDropdownOpen={setToolsDropdownOpen} // Function to close dropdown
                    />
